...
public class DSOSGIServicesExamples extends SlingSafeMethodsServlet {
	
	protected void doGet(SlingHttpServletRequest req,SlingHttpServletResponse res) throws IOException
	{
		String queryparam = req.getParameter("qparam");
		String query ="SELECT * FROM [cq:Page] AS s WHERE ISDESCENDANTNODE([/content/kalyan]) AND s.[jcr:content/jcr:title] like '"+queryparam+"%'";
