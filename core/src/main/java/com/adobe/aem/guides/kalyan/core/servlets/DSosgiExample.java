...
public class DSosgiExample extends SlingSafeMethodsServlet{
	private static final Logger LOG  = LoggerFactory.getLogger(DSosgiExample.class);
	...
	protected void doGet(SlingHttpServletRequest req,SlingHttpServletResponse res) throws IOException
	{
		...
		{
			LOG.info("showing workflow is exception",e.getMessage());
		}
