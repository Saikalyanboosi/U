...
public class OSGIkalyanservice extends SlingAllMethodsServlet{
	protected void doGet(SlingHttpServletRequest req, SlingHttpServletResponse res) throws IOException
	{
		...
		ResourceResolver resolvered = req.getResourceResolver();
		Iterator<Resource> resources = resolvered.findResources(query,Query.JCR_SQL2);
